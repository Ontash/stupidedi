  ...
  module Guides
    module FiftyTen
      module X222A1
        ...
        #
        #   For the purposes of this documentation, the claim detail information
        #   is presented only in the dependent level. Specific claim detail
        #   information can be given in either the subscriber or the dependent
        #   hierarchical level. Because of this, the claim information is said
        #   to "float." Claim information is positioned in the same hierarchical
        #   level that describes its owner-participant, either the subscriber or
        #   the dependent. In other words, the claim information, Loop 2300, is
        #   placed in the hierarchical level when the patient is the subscriber,
        #   or it is placed at the patient/dependent hierarchical level when the
        #   patient is the dependent of the subscriber as shown here. When the
        #   patient is the subscriber, loops 2000C and 2010CA are not sent. See
        #   1.4.3.2.2.1, HL Segment, for details.
        #
        # So here we build the 2300 LoopDef and later copy it as a child of the
        # 2000B and 2000C loops. The actual transaction set begins below with
        # the line that starts HC837 = ...
        ...
        loop2300 =
          d::LoopDef.build("2300 CLAIM INFORMATION",
              ...
              b::Segment(2410, s::HCP, "Claim Pricing/Repricing Information",
                r::Situational, d::RepeatCount.bounded(1),
                b::Element(e::Required,    "Pricing Methodology", b::Values("00", "01", "02", "03", "04", "05", "07", "08", "09", "10", "11", "12", "13", "14")),
              ...
              d::LoopDef.build("2400 SERVICE LINE NUMBER",
                ...
                b::Segment(4200, s::PWK, "Line Supplemental Information",
                  r::Situational, d::RepeatCount.bounded(10),
                  b::Element(e::Required,    "Attachment Report Type Code", b::Values("03", "04", "05", "06", "07", "08", "09", "10", "11", "13", "15", "21", "A3", "A4", "AM", "AS", "B2", "B4", "BR", "BS", "BT", "CB", "CK", "CT", "D2", "DA", "DA", "DB", "DG", "DJ", "DS", "EB", "HC", "HR", "I5", "IR", "LA", "M1", "MT", "NN", "OB", "OC", "OD", "OE", "OX", "OZ", "P4", "P5", "PE", "PN", "PO", "PQ", "PY", "PZ", "RB", "RR", "RT", "RX", "SG", "V5", "XP")),
                  b::Element(e::Required,    "Attachment Transmission Code", b::Values("AA", "BM", "EL", "EM", "FT", "FX")),
                  b::Element(e::NotUsed,     "Report Copies Needed"),
                  b::Element(e::NotUsed,     "Entity Identifier Code"),
                  b::Element(e::Situational, "Identification Code Qualifier", b::Values("AC")),
                ...
                b::Segment(4500, s::CRC, "Condition Indicator/Durable Medical Equipment",
                  ...
                  b::Element(e::Situational, "Condition Indicator", b::Values("38", "ZV")),
                  b::Element(e::NotUsed,     "Condition Indicator"),
                  b::Element(e::NotUsed,     "Condition Indicator"),
                  b::Element(e::NotUsed,     "Condition Indicator")),
                ...
                b::Segment(4920, s::HCP, "Line Pricing/Repricing Information",
                  ...
                  b::Element(e::Situational, "Repriced Approved Ambulatory Patient Group Amount"),
                  b::Element(e::NotUsed,     "Product/Service ID"),
                  b::Element(e::Situational, "Product or Service ID", b::Values("ER", "HC", "IV", "WK")),
                ...
                d::LoopDef.build("2410 DRUG IDENTIFICATION",
                  ...
                  b::Segment(4930, s::LIN, "Drug Identification",
                    ...
                    b::Element(e::Required,    "Product or Service ID Qualifier", b::Values("N4", "EN", "EO", "HI", "ON", "UK", "UP")),
                    b::Element(e::Required,    "National Drug Code or Universal Product Number"),

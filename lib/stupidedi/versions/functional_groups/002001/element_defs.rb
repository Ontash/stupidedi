        ...
        module ElementDefs
          ...
          E641  = t::ID.new(:E641 , "Status Reason Code"                   , 3, 3,
             s::CodeList.build(
              ...
              "A24" => "Accident",
              "Del" => "y caused by shipment being contained in vehicle involved in accident",
              "A25" => "Package Received At Destination Station Without Airbill",
              "A26" => "Consignee Related",
              "Uns" => "ecified delay caused by consignee",
              "A27" => "Driver Related",
              ...
              "D07" => "Student was received from a nonpublic school either in or out of the district or has returned after having been enrolled in a home education program; The student must have been enrolled", "pre" => "iously in a public school this year",
